...
def search_by_genre(genre: str) -> list[str] | str:
...
def search_by_title(title: str) -> list[str]| str:
    movies = []
    for movie in data.movie_database:
...
def search_by_rating(rating: int) -> list[str] | str:
    movies = []

    for movie in data.movie_database:
        if movie['rating'] >= rating:
            movies.append(movie)  # Only append the title of the movie for the result
...
def search_by_length(length: int) -> list[str] | str:
    movies = []
    for movie in data.movie_database:
